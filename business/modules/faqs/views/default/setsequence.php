...
$this->title = 'Update Sequence of FAQs';
            ...
            <div class="box-body">
                <div class="col-md-12">
                    <div class="col-md-12">
                        ...
                        <a href="javascript:void(0);" class="reorder_link btn btn-info" id="saveReorder">Click to Update FAQs Sequence</a>
                        <div id="reorderHelper" class="light_box" style="display:none;">1. Drag FAQs to update sequence.<br>2. Click 'Save Updated Sequence' when finished.</div>
                        <div class="gallery">
...
<?php
$form_validate_url = \yii\helpers\Url::toRoute(["/faqs/default/savesequence"]);
$script = <<< JS
        ...
        $('.reorder_link').on('click', function() {
            ...
            $("#saveReorder").click(function(e) {
                if (!$("#saveReorder i").length) {
                    ...
                    $("#reorderHelper").html("Updating FAQs Sequence - This could take a moment. Please don't navigate away from this page.").removeClass('light_box').addClass('notice notice_error');
                    var h = [];
