                ...
                <table class="table w-100 border-0 border_o d-inline-block py-3">
                    <tbody class="tbody-leads sighting-leads py-5 w-100">
                        <tr>
                            ...
                            <td style="width: 80%;">
                                <p><?= date("d F Y, h:i A", $model->updated_at); ?></p>
                            </td>
                        </tr>
                        <tr>
                            <td>Caption:</td>
                ...
                <div class="row justify-content-between gx-0">
                                    ...
                                    <div class="card-body">
                                        <div class="liksMain pt-0 d-flex align-items-center justify-content-between">
                                            <div class="likes d-flex align-items-center gap-1">
                                                <img src="<?= $this->params['baseurl'] ?>/images/like.svg" alt="">
                                                <a href="">
                    ...
                    <div class="col-xl-6">
                        <div class="galleryCard video-area">
                            ...
                            <div class="card p-0 border-0 bg-transparent">
                                <div class="">
                                    <a href=""> <img src="<?= Yii::$app->params['s3_endpoint'] . '/' . $model->filepath ?>"
                    ...
                    <div class="col-12 pt-5">
                        <!-- <div class="d-flex justify-content-center gap-4">
                            <a href="" class="sequenceBtn cancleBtn">Delete</a>
                ...
                <div class="one_box position-relative pb-4">
                    ...
                    ?>
                            <div class="postcomment d-flex gap-2 pt-3 w-100">
                                <div class="avatar"><img alt="Profile"
                                        class="rounded-circle bg-info" src="<?= $comments->user->profile_display_image ?>">
                                </div>
                                <div class="text_com">
