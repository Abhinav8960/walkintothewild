            ...
            <div class="col-12 mb-4">
                <div class="topParent d-flex justify-content-between align-items-center">
                    ...
                    <div class="butonsParent d-flex align-items-center gap-3">
                        <div class="edinBtn">
                            <?= Html::a('View', [Url::toRoute(['view', 'id' => $package->id])], ['class' => 'btn', 'title' => 'View']) ?>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-12 my-4">
        ...
        <div class="wrapper-skybgsafri pb-0">
            ...
            <div class="row pt-md-4 align-items-center gx-4 border_bottom2 pb-4">
                ...
                <?php } ?>
                <div class="d-lg-block  mobile_didplay_block col-lg-12 ">
                    <div
                        class="d-flex justify-content-end align-items-center flex-wrap pt-lg-0 pt-sm-3 pt-3">
