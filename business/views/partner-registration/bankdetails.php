...
<?= $this->render('card', ['currentStep' => 4]) ?>
...
<div class="container mt-5">
    <div class="accordion" id="formAccordion">
            ...
            <div class="accordion-item mb-3">
                ...
                <div id="collapse4" class="accordion-collapse collapse show" aria-labelledby="heading4" data-bs-parent="#formAccordion">
                    <div class="accordion-body">
                        <?= $this->render('_bankdetails_form', ['currentStep' => 4, 'model' => $model]) ?>
                    </div>
                </div>
            </div>
