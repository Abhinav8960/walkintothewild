    ...
    <div class="container mt-5">
        <div class="accordion" id="formAccordion">
          ...
          <div class="accordion-item mb-3">
            ...
            <?php ;} elseif ($partner_model != null && $partner_model->form2_status == PartnerRegistration::FORM_FILLED) { ?>
                <h2 class="accordion-header d-flex align-items-stretch justify-content-between" id="heading2">
                    <button class="accordion-button collapsed flex-grow-1 text-start background-success text-white" type="button"
                        data-bs-toggle="collapse" data-bs-target="#collapse2"
            ...
            <?php ;} elseif ($partner_model != null && $partner_model->form2_status == PartnerRegistration::FORM_APPROVED) { ?>
                <h2 class="accordion-header d-flex align-items-stretch justify-content-between" id="heading2">
                    <button class="accordion-button collapsed flex-grow-1 text-start background-success text-white" type="button"
                        data-bs-toggle="collapse" data-bs-target="#collapse2"
                        aria-expanded="false" aria-controls="collapse2">
          ...
          <div class="accordion-item mb-3">
            ...
            <?php ;} elseif ($partner_model != null && $partner_model->form3_status == PartnerRegistration::FORM_FILLED) { ?>
                <h2 class="accordion-header d-flex align-items-stretch justify-content-between" id="heading3">
                    <button class="accordion-button collapsed flex-grow-1 text-start background-success text-white" type="button"
                        data-bs-toggle="collapse" data-bs-target="#collapse3"
            ...
            <?php ;} elseif ($partner_model != null && $partner_model->form3_status == PartnerRegistration::FORM_APPROVED) { ?>
                <h2 class="accordion-header d-flex align-items-stretch justify-content-between" id="heading3">
                    <button class="accordion-button collapsed flex-grow-1 text-start background-success text-white" type="button"
                        data-bs-toggle="collapse" data-bs-target="#collapse3"
                        aria-expanded="false" aria-controls="collapse3">
          ...
          <div class="accordion-item mb-3">
            ...
            <?php ;} elseif ($partner_model != null && $partner_model->form4_status == PartnerRegistration::FORM_FILLED) { ?>
                <h2 class="accordion-header d-flex align-items-stretch justify-content-between" id="heading4">
                    <button class="accordion-button collapsed flex-grow-1 text-start background-success text-white" type="button"
                        data-bs-toggle="collapse" data-bs-target="#collapse4"
            ...
            <?php ;} elseif ($partner_model != null && $partner_model->form4_status == PartnerRegistration::FORM_APPROVED) { ?>
                <h2 class="accordion-header d-flex align-items-stretch justify-content-between" id="heading4">
                    <button class="accordion-button collapsed flex-grow-1 text-start background-success text-white" type="button"
                        data-bs-toggle="collapse" data-bs-target="#collapse4"
                        aria-expanded="false" aria-controls="collapse4">
          ...
          <div class="accordion-item mb-3">
                ...
                <?php ;} elseif ($partner_model != null && $partner_model->form5_status == PartnerRegistration::FORM_FILLED) { ?>
                    <h2 class="accordion-header d-flex align-items-stretch justify-content-between" id="heading5">
                        <button class="accordion-button collapsed flex-grow-1 text-start background-success text-white" type="button"
                            data-bs-toggle="collapse" data-bs-target="#collapse5"
                ...
                <?php ;} elseif ($partner_model != null && $partner_model->form5_status == PartnerRegistration::FORM_APPROVED) { ?>
                    <h2 class="accordion-header d-flex align-items-stretch justify-content-between" id="heading5">
                        <button class="accordion-button collapsed flex-grow-1 text-start background-success text-white" type="button"
                            data-bs-toggle="collapse" data-bs-target="#collapse5"
                            aria-expanded="false" aria-controls="collapse5">
