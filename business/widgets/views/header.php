      ...
      <div class="navbar-menu-wrapper d-flex ">
        <div class="sidebar-brand-wrapper  px-3 py-3 d-lg-none d-block">
          <a href="/" class="header-logo">
            <img src="<?= $this->params['baseurl'] ?>/images/logo-mini.svg" class="mobile-logo logo-1" alt="logo">
            <img src="<?= $this->params['baseurl'] ?>/images/logo-mini.svg" class="mobile-logo dark-logo-1" alt="logo">
          </a>
        </div>
          ...
          <li class="nav-item " id="dropdown-pro">
            <a href="#" class="d-flex align-items-center">
              <div class="dorpdown-profile me-2">
                <img src="<?= $this->params['baseurl'] ?>/images/default_witw.png" class="mobile-logo logo-1" alt="logo">
                <img src="<?= $this->params['baseurl'] ?>/images/default_witw.png" class="mobile-logo dark-logo-1" alt="logo">
              </div>
