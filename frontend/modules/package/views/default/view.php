        ...
        <div class="row mb-4 mt-5 justify-content-center mt-4 itenary_tabs">
            <div class="col-lg-12 col-xl-11 safartabs position-relative">
                ...
                <div class="tab-content accordion" id="myTabContent">
                    ...
                    <div class="tab-pane fade accordion-item" id="getting-there" role="tabpanel" aria-labelledby="howto-reach" tabindex="0">
                    ...
                    <div class="tab-pane fade accordion-item" id="policy" role="tabpanel" aria-labelledby="howto-reach" tabindex="0">
                        <h2 class="accordion-header d-lg-none" id="headingFour">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                POLICY INFO
                            </button>
