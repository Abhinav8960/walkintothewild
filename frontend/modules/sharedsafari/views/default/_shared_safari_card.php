            ...
            <div class="col-6">
                <div class="users">
                    ...
                    ?>
                        ...
                        <a href="<?= Url::toRoute(['/profile/default/index', 'user_handle' => $share_safari->getOrganizedbyuserhandel()]) ?>" data-pjax="0"><img src="<?= $share_safari->user && $share_safari->user->avatar <> '' ? $share_safari->user->avatar : $this->params['baseurl'] . '/img/Share-Safari/dpmain.png' ?>" alt="" class="rounded-circle"></a>
                    <?php } ?>
                </div>
            </div>
            <div class="col-6">
