                            ...
                            <div class="row">
                                ...
                                <div class="col-9 col-sm-9 col-md-9 col-lg-10 pt-sm-0 pt-3 maxWidth">
                                    <div class="safrititles 44">
                                        ...
                                        <div class="history">
                                            <button value="<?= Url::toRoute(['/sharedsafari/default/history', 'slug' => $share_safari->slug, 'organized_slug' => $share_safari->organizedslug ? $share_safari->organizedslug : '']) ?>" class="history_btn"><i class="fas fa-history" style="color: #FFD43B;"></i></button>
                                        </div>
                                        <div class="date_bx">
                                        ...
                                        <div class="d-flex gap-2 align-items-center">
                                            ...
                                            <?php if ($creator = $share_safari->user) {
                                                if (Yii::$app->user->identity && $creator->id == Yii::$app->user->identity->id && $creator->pop_up_message <> '') { ?>

                                                    <div class="modal fade _standard-text " id="popupModal" tabindex="-1" aria-labelledby="flagModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                <div class="modal-header justify-content-center" style="background-color: yellow;">
                                                                    <h4 class="modal-title w-100 text-center" id="exampleModalLabel">Alert</h4>
                                                                    <button type="button" class="btn_close ms-auto" data-bs-dismiss="modal" aria-label="Close">
                                                                        <i class="fa-solid fa-xmark"></i>
                                                                    </button>
                                                                ...
                                                                <div class="modal-body">
                                                                    <div id='departuremodalContent'>
                                                                        <h6 class="text-center"><?= $creator->pop_up_message ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
