                                        ...
                                        <ul class="artical-info ">
                                            <?php if ($topics = $article->articletopics) {
                                                foreach ($topics as $topic) { ?>
                                                    <li class="tgas_btns"><a href="<?= Url::toRoute(['/article/default/topic', 'slug' => $topic->articlename->slug]) ?>"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" x="0" y="0" viewBox="0 0 32 32" style="enable-background:new 0 0 512 512" xml:space="preserve" class="hovered-paths me-1">
                                                                <g>
                                                            ...
                                                            </svg><?= isset($topic->articlename->title) ? $topic->articlename->title : ''; ?> </a></li>
                                            <?php }
                                            } ?>
