        ...
        <div class="tab-pane fade show active" id="pills-followers" role="tabpanel" aria-labelledby="pills-followers-tab" tabindex="0">
            <div class="row">
                <div class="col-8">
                    <div class="card mt-2">
                        <div class="card-body">
                            <h5>Shared Safari Organized by <?= Yii::$app->user->identity->id == $user->id ? 'me' : $user->name ?> </h5>
                            <div class="row">
                                <?php if ($organized_by) {
                ...
                <div class="col-8">
                    <div class="card mt-2">
                        <div class="card-body">
                            <h5>Shared Safari Joined by <?= Yii::$app->user->identity->id == $user->id ? 'me' : $user->name ?> </h5>
                            <div class="row">
                                <?php if ($joined_by) {
