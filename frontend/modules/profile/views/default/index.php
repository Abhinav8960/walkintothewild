                ...
                <div class="card position-relative" style="min-height: 350px;">
                    <div class="card-body">
                        ...
                        <div class="logininfo text-center">
                            <h6>Please log in to view the About <br>information.</h6>
                            <div class="viewAllreview">
                                <a href="/site/login?authclient=google&referrer=<?= Url::toRoute(['/profile/default/index', 'user_handle' => $user->user_handle]) ?>">Login</a>
                            </div>
                        </div>
                    </div>
                </div>
