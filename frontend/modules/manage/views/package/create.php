                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <?= $form->field($model, 'safari_type', [
                                        'labelOptions' => ['class' => 'Modal_label']
                                    ])->dropDownList(['1' => 'Shared Safari', '2' => 'Private Safari'], ['class' => 'form-select form-select-lg mb-3', 'prompt' => 'Select Safari Type'])->label('Safari Type <span class="necessary">*</span>') ?>
                                </div>
