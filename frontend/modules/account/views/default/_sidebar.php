...
<div class="nav flex-column nav-pills card-body">
    ...
    <a href="<?= Url::toRoute(['/account/login-info']) ?>" class="nav-link mb-2 <?= $active == 'login' ? 'active' : '' ?>"><i class="fa-solid fa-right-to-bracket me-2"></i> Login Information</a>
    ...
    <a href="<?= Url::toRoute(['/account/privacy']) ?>" class="nav-link mb-2 <?= $active == 'privacy' ? 'active' : '' ?>"><i class="fa-solid fa-shield-halved me-2"></i> Privacy</a>
