...
<div class="container-fluid">
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-3 row-cols-xl-3 row-cols-xxl-4  gx-xxl-5 gx-lg-4 padding-setDes padding_left px-sm-2 margin_bottomfooter">
                    ...
                    <div class="artical_cards h-100">
                        ...
                        <div class="lower-content">
                            ...
                            <div class="artical-info justify-content-center">
                                <a href="<?= Url::toRoute(['/article/default/view', 'slug' => $featured_article->slug]) ?>" style="color: #9C9C9C;"><img src="<?= $this->params['baseurl'] ?>/img/comments.png" alt=""> <?= $featured_article->getArticlecomments()->where(['status' => 1])->count() ?> Comments</a>
