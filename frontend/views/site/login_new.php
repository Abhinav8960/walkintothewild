        ...
        <div class="row py-4">
          <div class="col-12 logindesign">
            ...
            <div class="form_design">
              ...
              <div class="emailfields" style="display:none;" id="email_password">
                <?= $form->field($model, 'email_code')->passwordInput(['autofocus' => true, 'form-control' => 'form-control', 'style' => 'padding: 12px 10px;', 'placeholder' => 'Enter your Password'])->label(false) ?>
              </div>
              <?php /*
