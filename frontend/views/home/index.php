...
<section class="animal-wrapper pb-4">
    ...
    <div class="animal-safari mb-4">
        <div class="inner_animals position-relative">
            <img src="<?= $this->params['baseurl'] ?>/img/snowleopardbg.jpg" alt="" class="position-relative w-100">
            <div class="safariBox">
                <div class="container">
                    <div class="row align-items-center ">
                        <div class="col-lg-6 col-md-5 text-center position-relative">
                            <img src="<?= $this->params['baseurl'] ?>/img/Snow-Leopard.png" alt="" class="imag_width position-relative">
                        </div>
                        <div class="col-lg-6 col-md-7">
                            <div class="safari_content">
                                <h5>SNOW LEOPARD</h5>
    ...
    <div class="animal-safari mb-4">
        <div class="inner_animals position-relative">
            <img src="<?= $this->params['baseurl'] ?>/img/liontailedbg.jpg" alt="" class="position-relative w-100">
            <div class="safariBox">
                <div class="container">
                    <div class="row align-items-center ">
                        <div class="col-lg-6 col-md-5 text-center position-relative">
                            <img src="<?= $this->params['baseurl'] ?>/img/Lion-tailed-Macaque.png" alt="" class="imag_width position-relative">
                        </div>
                        <div class="col-lg-6 col-md-7">
                            <div class="safari_content">
                                <h5>LION-TAILED MACAQUE</h5>
                                <p>IUCN: ENDANGERED</p>
                                <div class="knowmore">
                                    <a href="" class="btn-knowmore">Know More</a>
                                </div>
    ...
    <div class="animal-safari mb-4">
        <div class="inner_animals position-relative">
            <img src="<?= $this->params['baseurl'] ?>/img/redpandabg.jpg" alt="" class="position-relative w-100">
            <div class="safariBox">
                <div class="container">
                    <div class="row align-items-center ">
                        <div class="col-lg-6 col-md-5 text-center position-relative">
                            <img src="<?= $this->params['baseurl'] ?>/img/Red-Panda.png" alt="" class="imag_width position-relative">
                        </div>
                        <div class="col-lg-6 col-md-7">
                            <div class="safari_content">
                                <h5>RED PANDA</h5>
    ...
    <div class="animal-safari mb-4">
        <div class="inner_animals position-relative">
            <img src="<?= $this->params['baseurl'] ?>/img/nilgirimartenbg.jpg" alt="" class="position-relative w-100">
            <div class="safariBox">
                <div class="container">
                    <div class="row align-items-center ">
                        <div class="col-lg-6 col-md-5 text-center position-relative">
                            <img src="<?= $this->params['baseurl'] ?>/img/Nilgiri-Marten.png" alt="" class="imag_width position-relative">
                        </div>
                        <div class="col-lg-6 col-md-7">
                            <div class="safari_content">
                                <h5>NILGIRI MARTEN</h5>
                                <p>IUCN: VULNERABLE</p>
                                <div class="knowmore">
                                    <a href="" class="btn-knowmore">Know More</a>
                                </div>
    ...
    <div class="animal-safari mb-4">
        <div class="inner_animals position-relative">
            <img src="<?= $this->params['baseurl'] ?>/img/geesgoldenbg.jpg" alt="" class="position-relative w-100">
            <div class="safariBox">
                <div class="container">
                    <div class="row align-items-center ">
                        <div class="col-lg-6 col-md-5 text-center position-relative">
                            <img src="<?= $this->params['baseurl'] ?>/img/Gee’s-Golden-Langur.png" alt="" class="imag_width position-relative">
                        </div>
                        <div class="col-lg-6 col-md-7">
                            <div class="safari_content">
                                <h5>HIMALAYAN BROWN BEAR</h5>
