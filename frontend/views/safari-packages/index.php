                                    ...
                                    <div class="sharesafri-card tourpackage">
                                        ...
                                        <div class="shareimg">
                                            <a href="/package/<?= $package->package_slug ?>">
                                                <img src="<?= isset($package->package_image) ? $package->imagepath : $this->params['baseurl'] . '/img/NewBanner_big.png' ?>" alt=""></a>
                                        </div>
                                        <div class="card_body">
                                            <!-- <div class="top_seats">
                                                ...
                                                <div class="col-5">
                                                    <div class="safari text-center">
                                                        <div class="joinsafari package">
                                                            <h6 class=" titlePrice">₹ <?= $package->total_price ?> </h6>
                                            ...
                                            <div class="card_body">
                                                ...
                                                if (Yii::$app->user->identity) {
                                                    ...
                                                    if ($share_safari_intrested) {
                                                        $class = 'background-color: #4B4B4B !important;';
                                                    }
                                                } ?>
                                                ...
                                                <div class="titleDate">
                                                    <h6><a href="<?= Url::toRoute(['/sharedsafari/default/view', 'slug' => $share_safari->slug, 'organized_slug' => $share_safari->organizedslug ? $share_safari->organizedslug : '']) ?>"><?= isset($share_safari->park_id) ? GeneralModel::safariparkoption()[$share_safari->park_id] : '' ?></a></h6>
                                                    <div class="orgnizer">
