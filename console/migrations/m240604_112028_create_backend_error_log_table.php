...
/**
 * Handles the creation of table `{{%backend_error_log}}`.
 */
class m240604_112028_create_backend_error_log_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->createTable('{{%backend_error_log}}', [
            'id' => $this->primaryKey(),
    ...
    {
        $this->dropTable('{{%backend_error_log}}');
    }
}
