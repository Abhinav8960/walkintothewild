...
class m240605_105017_add_fields_in_article_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addColumn('{{%article}}', 'article_date', $this->date()->null()->after('meta_keywords'));
        $this->alterColumn('{{%article}}', 'view', $this->integer()->null());
        $this->renameColumn('{{%article}}', 'banner', 'banner_image');
