...
class CreateDepartureForm extends \frontend\models\form\CreateDepartureForm
{
    public function rules()
    {
        return [
            ...
            [['getting_there', 'share_safari_terms_condtition', 'privacy_policy', 'change_policy', 'what_you_must_carry', 'date_change_policy', 'refund_policy', 'share_safari_terms_condtition', 'privacy_policy'], 'string', 'max' => 1000],
            [['safari_plan'], 'string'],
