...
class PackageSearch extends Package
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'package.id' => $this->id,
            'package.no_of_day' => $this->no_of_day,
            'package.start_location' => $this->start_location,
            'package.end_location' => $this->end_location,
            'package.stay_category_id' => $this->stay_category_id,
            'package.package_inclusion' => $this->package_inclusion,
            'package.package_description' => $this->package_description,
            'package.package_exclusion' => $this->package_exclusion,
            'package.package_terms_condtition' => $this->package_terms_condtition,
            'package.package_slug' => $this->package_slug,
            'package.package_image' => $this->package_image,
            'package.created_at' => $this->created_at,
            'package.created_by' => $this->created_by,
            'package.updated_at' => $this->updated_at,
            'package.updated_by' => $this->updated_by,
        ...
        if ($this->package_include) {
            $query->joinwith(['packageincluded' => function ($package_include_query) {
                $package_include_query->andFilterWhere(['include_id' => $this->package_include, 'selection' => 1]);
            }]);
        }
