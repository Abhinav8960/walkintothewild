...
use api\models\park\SafariParkFloraFauna;

/**
 * SafariParkFloraFaunaSearch represents the model behind the search form of `api\models\park\SafariParkFloraFauna`.
 */
