...
class DefaultController extends SafariController
{
     ...
     *             @OA\Property(
     *                 property="payu",
     *                 ref="#/components/schemas/FixedDeparturePayUPaymentSchema"
     *             )
     *         )
     *     ),
     *
    ...
    public function autoApproved($share_safari_id, $version)
    {
        ...
        try {
            ...
            if (in_array($share_safari->status, [ShareSafari::STATUS_CREATE, ShareSafari::STATUS_ACTIVE])) {
                ...
                $share_safari->status = ShareSafari::STATUS_SUSPEND;
            }
     ...
     *             property="message",
     *             type="string",
     *             example="Shared Safari update successfully."
     *         )
     *     )
     * ),
     * @OA\Response(
     ...
     *                 property="message",
     *                 type="string",
     *                 example="Message Send, You can check Your inbox!!!"
     *             )
     *         )
     *     ),
     *     @OA\Response(
