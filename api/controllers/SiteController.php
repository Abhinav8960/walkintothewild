...
class SiteController extends RestController
{
     ...
     *                 property="user",
     *                 type="object",
     *                 ref="#/components/schemas/UserViewSchema"
     *             )
     *         )
     *     ),
     *
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="message", type="string", example="Term of Use Not Found")
     *         )
     *     ),
     * )
     */
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="message", type="string", example="Privacy Policy Not Found")
     *         )
     *     ),
     * )
     */
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="message", type="string", example="Refund Policy Not Found")
     *         )
     *     ),
     * )
     */
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="message", type="string", example="Report page reason Not Found")
     *         )
     *     )
     * )
     */
     ...
     *             @OA\Property(property="message", type="string", example="Your information will be deleted in the upcoming 90 days. We will miss you!")
     *         )
     *     ),
     *     @OA\Response(
     *         response=401,
