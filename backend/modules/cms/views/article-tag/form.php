...
$this->title = 'Article Tag';
$this->params['breadcrumbs'][] = "Create";
if (isset($model->master_article_tag_model->id)) {
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <?= $form->field($model, 'slug')->textInput(['maxlength' => true, 'placeholder' => 'Enter Slug', 'readonly' => isset($model->master_article_tag_model->id) ? true : false]) ?>
                    </div>
                </div>
                ...
                <div class="row">
                    <?php
                    if (!empty($model->master_article_tag_model->id)) { ?>
                        <div class="col-md-6">
