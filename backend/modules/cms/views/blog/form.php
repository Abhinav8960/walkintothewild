                ...
                <div class="row">
                    <div class="col-md-4">
                        <?= $form->field($model, 'title')->textInput([
                            ...
                            'id' => 'blogform-title', // Add an ID for JavaScript targeting
                        ]) ?>
                    </div>
                    ...
                    <div class="col-md-4">
                        <?= $form->field($model, 'slug')->textInput([
                            ...
                            'readonly' => isset($model->blog_model->id) ? true : false, // Make it readonly for existing records
                            'id' => 'blogform-slug', // Add an ID for JavaScript targeting
                        ]) ?>
                    </div>

                    <div class="col-md-4">
                        <?= $form->field($model, 'blog_author_id')->dropDownList(GeneralModel::authoroption(), ['prompt' => '--Select Author Name--']) ?>
                    </div>


                    <div class="col-md-4 select_width">
                        <?= $form->field($model, 'blog_tags')->widget(\kartik\select2\Select2::classname(), [
                    ...
                    <div class="col-md-4">
                        <?= $form->field($model, 'blog_topics')->widget(\kartik\select2\Select2::classname(), [
                    ...
                    if ($model->blog_model->banner_image) { ?>
                        <div class="col-md-3">
                            <?= $form->field($model, 'banner_image')->fileInput()->label('Blog Image (JPEG / JPG / PNG / 940px * 430px / 250kb)') ?>
                        </div>
                        <div class="col-md-1">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <?= $form->field($model, 'blog_date')->input('date', ['class' => 'form-control']) ?>
                        </div>
                        <div class="col-md-4">
...
$script = <<< JS
    $(function(){
        $('#blogform-is_schedule').change(function(){
            var comment_allowed=$("#blogform-is_schedule").val();
