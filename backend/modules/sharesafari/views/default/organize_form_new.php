            ...
            <div class="col-12 mb-2">
                ...
                <?= $form->field($model, 'park_id')->dropDownList(
                    ...
                    [
                        ...
                        'onchange' => '
                     $.get( "' . Yii::$app->urlManager->createUrl('/sharesafari/default/getparkimage?id=') . '"+$(this).val(), function( data ) {
    ...
    <div class="row mt-2 pe-0">
                ...
                <div class="selects w-100">
                    ...
                    <?= $form->field($model, 'total_seat')->dropDownList(
                        ...
                        [
                            ...
                            'class' => 'form-select form-select-lg mb-3',
                            'onchange' => '
                     $.get( "' . Yii::$app->urlManager->createUrl('/sharesafari/default/dynamicsharedseat?total_seat=') . '"+$(this).val(), function( data ) {
        ...
        <div class="col-lg-12 ">
            <div class="creat-safri d-flex justify-content-end">
                <button class="btn btn-outline-danger me-2" data-bs-dismiss="modal" aria-label="Close">Cancel</button>
                <?php if (isset($model->shared_safari_request_model->id)) { ?>
                    <?= Html::submitButton('Update ', ['class' => 'safari_create font_set w-auto ms-2']) ?>
                <?php } else {  ?>
                    <?= Html::submitButton('Create ', ['class' => 'btn btn-orange text-white']) ?>
                <?php } ?>
