    ...
    <div class="col-12">
        <div class="wrapper-skybgsafri pb-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-9 col-sm-9 col-md-9 col-lg-10 pt-sm-0 pt-3 maxWidth">
                            <div class="safrititles">
                                ...
                                <p class="mb-0 pt-1">Organized by <strong><?= $share_safari->organizedbyname ?></strong></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row ps-1">
                        ...
                        <div class="col-12 col-sm-6  mb-3">
                            <div class="safridetails_form d-flex gap-3 ">
                                ...
                                <div class="text-form">
                                    <p class="mb-0"><?php
                                                    $pick_drop_includes = ShareSafariIncluded::find()->where(['share_safari_id' => $share_safari->id, 'include_id' => 3, 'selection' => 1, 'status' => 1, 'version' => $share_safari->live_version])->limit(1)->one();
            ...
            <div class="row pt-md-4 align-items-center gx-4 border_bottom2 pb-4">
                ...
                <!-- <div class="col-8">
                    <div class="btn-delet float-end ">
                        <button class="btn_userarticle" style="background:#F7BF39 !important;color:black !important;padding: 10px 16px !important;" value="<?= \yii\helpers\Url::toRoute(['/sharesafari/default/fixed-departure-delete', 'id' => $share_safari->id]) ?>"><i class="fas fa-edit me-1"></i>Delete</button>
                    </div>
