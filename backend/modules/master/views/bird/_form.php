...
<div class="row">
    ...
    <div class="col-md-6">
        <?= $form->field($model, 'bird_type_id', ['inputOptions' => ['id' => 'title']])->dropDownList(
            GeneralModel::birdtypeoption(),
            [
                'prompt' => 'Select Bird Type',
            ]
        ); ?>
    </div>
    ...
    <?php
    if ($model->bird_model->image) { ?>
        <div class="col-md-1">
            <?php echo '<img src="' . $model->bird_model->imagepath . '" width="50" height="50"></img>'; ?>
        </div>
    <?php } ?>


    <?php if ($model->bird_model->id) { ?>
        <div class="col-md-3">
