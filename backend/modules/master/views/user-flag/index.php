...
/** @var common\models\master\userflag\MasterUserFlagSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'User Flag';
$this->params['breadcrumbs_home_url'] = '/master/user-flag';
                        ...
                        'buttons' => [
                            ...
                            'delete' => function ($url, $model) {
                                return  Html::a('<img src="' . $this->params['baseurl'] . '/img/delete.png" alt="" width="25" height="25">', ['delete', 'id' => $model->id], [
                                    ...
                                    'name' => 'Delete',
                                    'data' => [
                                        'confirm' => 'Are you sure you want to delete  ' . $model->user_flag . '?',
                                        'method' => 'post',
                                    ],
                                ]);
                            },
