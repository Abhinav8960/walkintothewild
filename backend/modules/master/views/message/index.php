...
/** @var common\models\master\message\MasterMessageSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Message';
$this->params['breadcrumbs_home_url'] = '/master/message';
                        ...
                        'buttons' => [
                            ...
                            'delete' => function ($url, $model) {
                                return  Html::a('<img src="' . $this->params['baseurl'] . '/img/delete.png" alt="" width="25" height="25">', ['delete', 'id' => $model->id], [
                                    ...
                                    'title' => 'Delete',
                                    'data' => [
                                        'confirm' => 'Are you sure you want to delete  ' . $model->code . '?',
                                        'method' => 'post',
                                    ],
                                ]);
                            },
