            ...
            <div class="col-md-12 mt-4">
                <div class="datatable-box-wrapper">
                    <div class="text-right">
                        <small class="text-danger float-left mb-2">All entries in the CSV file should be filled in the correct format. If data is not filled in the correct format, the city list will not get uploaded. </small>
