...
<div class="card">
    <div class="card-body">
        ...
        <div class="row">
            ...
            <?php
            if ($model->birding_park_model->logo) { ?>
                <div class="col-md-3">
                    <?= $form->field($model, 'logo')->fileInput() ?>
                </div>
                <div class="col-md-1">
                    <?php echo '<img src="' . $model->birding_park_model->logoimagepath . '" width="50" height="50"></img>'; ?>
                </div>
            <?php } else { ?>
                <div class="col-md-4">
                    <?= $form->field($model, 'logo')->fileInput() ?>
            ...
            <?php if ($model->birding_park_model->id) { ?>
                <div class="col-md-3">
            ...
            <div class="col-md-3 select_width">
                <?= $form->field($model, 'birding_session')->widget(\kartik\select2\Select2::classname(), [
            ...
            <?php
            if ($model->birding_park_model->feature_image) { ?>
                <div class="col-md-1">
                    <?php echo '<img src="' . $model->birding_park_model->featureimagepath . '" width="50" height="50"></img>'; ?>
                </div>
            <?php } ?>
        </div>
        <hr>
