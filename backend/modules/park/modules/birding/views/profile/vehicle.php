...
$this->title = 'Birding Park Vehicle';
$this->params['breadcrumbs_home_url'] = '#';
$this->params['breadcrumbs'][] = $this->title;
$this->params['title'] = $this->title;
?>
<div class="panel panel-primary tabs-style-2">
    <?= $this->render('@backend/modules/park/modules/birding/views/profile/_profile_navbar', ['birding_park' => $birding_model, 'vehicle_active' => 'active']) ?>
        ...
        <div class="tab-content">
            <div class="tab-pane active">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="/park/birding/profile/createvehicle?birding_park_id=<?= $birding_model->id ?>" class="btn btn-orange  mt-3 col-md-2 float-end mb-3">+ Create</a>
                                        ...
                                        'buttons' => [
                                            'update' => function ($url, $model) {
                                                return  Html::a('<img src="/img/update.png" alt="" width="25" height="25">
                                                 ', ['updatevehicle', 'birding_park_id' => $model->birding_park_id, 'id' => $model->id], [
