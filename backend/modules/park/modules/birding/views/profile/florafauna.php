        ...
        <div class="tab-content">
            <div class="tab-pane active">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="/park/birding/profile/createflorafauna?birding_park_id=<?= $birding_model->id ?>" class="btn btn-orange  mt-3 col-md-2 float-end mb-3">+ Create</a>
                        ...
                        <div class="table-responsive">
                            <?= GridView::widget([
                             ...
                             ', ['updateflorafauna', 'birding_park_id' => $model->birding_park_id, 'id' => $model->id], [
