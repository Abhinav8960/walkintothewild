...
<div class="panel panel-primary tabs-style-2">
    <?= $this->render('@backend/modules/park/modules/safari/views/profile/_profile_navbar', ['safari_park' => $map_model, 'map_active' => 'active']) ?>
    ...
    <div class="panel-body tabs-menu-body main-content-body-right border">
        <div class="tab-content">
            <div class="tab-pane active">
                ...
                $latitude = $map_model->latitude;
                $longitude = $map_model->longitude;
