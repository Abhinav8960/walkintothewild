...
namespace backend\modules\leadoperatorwise\controllers;
...
class DefaultController extends Controller
{
    ...
    public function actionView($id,$operator_id)
    {
        ...
        $quotations = LeadPartnerQuotes::find()->where(['lead_id'=>$id,'partner_id'=>$operator_id])->all();
        $safari_operator = SafariOperator::find()->where(['id' => $operator_id,'status'=>SafariOperator::STATUS_ACTIVE])->one();
