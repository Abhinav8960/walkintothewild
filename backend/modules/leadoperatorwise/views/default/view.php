...
//     $this->params['buttons'][] = Html::button('Assign', ['value' => Url::toRoute(['/leadoperatorwise/default/assign', 'id' => $model->id]), 'class' => 'btn btn-info pop-up me-2', 'title' => 'Assign']);
// }
// if ($model->status == 1) {
//     $this->params['buttons'][] = Html::a('Inactive', [Url::toRoute(['/leadoperatorwise/default/inactive', 'id' => $model->id])], ['class' => 'btn btn-orange me-2', 'title' => 'Inactive']);
// }
// if ($model->status == 0) {
//     $this->params['buttons'][] = Html::a('Active', [Url::toRoute(['/leadoperatorwise/default/active', 'id' => $model->id])], ['class' => 'btn btn-orange me-2', 'title' => 'Inactive']);
// }
