...
class SitePagesController extends Controller
{
    ...
    {
        $content_types_data = \yii\helpers\ArrayHelper::map(SitePages::find()->select(['id', 'content_type'])->orderBy('content_type', 'asc')->groupBy('content_type')->all(), 'id', 'content_type');
        $content_type = [];
