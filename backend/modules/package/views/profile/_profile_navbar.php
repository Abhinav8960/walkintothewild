    ...
    <div class=" tab-menu-heading">
        <div class="tabs-menu1">
            ...
            <ul class="nav panel-tabs main-nav-line">
                ...
                <li><a href="/package/profile/exclusion?package_id=<?= $package->id ?>" class="nav-link <?= isset($exclusion_active) ? $exclusion_active : '' ?>">Exclusion</a></li>
                <li><a href="/package/profile/term-condition?package_id=<?= $package->id ?>" class="nav-link <?= isset($term_condition_active) ? $term_condition_active : '' ?>">Terms & Conditions</a></li>
