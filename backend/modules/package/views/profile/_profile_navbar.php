    ...
    <div class=" tab-menu-heading">
        <div class="tabs-menu1">
            ...
            <ul class="nav panel-tabs main-nav-line">
                ...
                <li><a href="/package/profile/additional-info?package_id=<?= $package->id ?>" class="nav-link <?= isset($additional_info_active) ? $additional_info_active : '' ?>">Additional Info</a></li>
