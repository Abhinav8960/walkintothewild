...
$this->params['breadcrumbs'][] =  ['label' => 'Registration', 'url' => '/registration/birding-operator-tour'];
...
$html = '';
$activies = GeneralModel::operatorresquestactivties($model->birdingoperator_request_approval_model->id);
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="text-box">
                    ...
                    <p>
                        <span>Phone Number: </span><?= $model->birdingoperator_request_approval_model->phone_no ?>
                    </p>
                    <p>
                        <span>Email Address: </span><?= $model->birdingoperator_request_approval_model->email ?>
                    </p>
                    <p>
                        <span>Alternate Phone Number: </span><?= $model->birdingoperator_request_approval_model->operator_phone_no ?>
                    </p>
                    <p>
                        <span>Alternate Email Address: </span><?= $model->birdingoperator_request_approval_model->operator_email ?>
                    </p>
                    <p>
            ...
            <div class="col-md-3">
                <div class="text-box">
                    ...
                    <p>
                        <span>Rating: </span><?= $model->birdingoperator_request_approval_model->google_rating ?>
                    </p>
                    <p>
                    ...
                    <p>
                        <span>Agree to the terms and conditions.: </span><?= ($model->birdingoperator_request_approval_model->is_agree == 1) ? 'Yes' : 'No' ?>
                    </p>
                    <p>
