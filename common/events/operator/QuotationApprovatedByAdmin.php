            ...
            'email' => [
                [
                    ...
                    'params' => [
                        ...
                        'validity_date_time' => !empty($this->quotation->validity_date_time) ? date('d M, Y h:i A', strtotime($this->quotation->validity_date_time)) : null,
                        'permit_booking_date_time' => !empty($this->quotation->permit_booking_date_time) ? date('d M, Y h:i A', strtotime($this->quotation->permit_booking_date_time)) : null,
