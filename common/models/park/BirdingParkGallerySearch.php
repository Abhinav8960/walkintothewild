...
/**
 * BirdingParkGallerySearch represents the model behind the search form of `common\models\park\BirdingParkGallery`.
 */
class BirdingParkGallerySearch extends BirdingParkGallery
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = BirdingParkGallery::find()->where(['status' => [1, 2]]);
