...
/**
 * This is the model class for table "birding_park_zone".
 *
 * @property int $id
 ...
 */
class BirdingParkZone extends \yii\db\ActiveRecord implements \common\interfaces\StatusInterface
{
