...
/**
 * PackageFeatureSearch represents the model behind the search form of `common\models\package\PackageFeature`.
 */
class PackageFeatureSearch extends PackageFeature
{
    /**
     * {@inheritdoc}
     */
