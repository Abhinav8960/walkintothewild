...
/**
 * This is the model class for table "moderation_video_frames".
 *
 * @property int $id
 * @property string $moderation_id
 * @property string $media_id
 * @property string|null $frames_info_id
 * @property int $frames_info_position
...
class ModerationVideoFrames extends \yii\db\ActiveRecord
{
    ...
    {
        return 'moderation_video_frames';
    }
    ...
    {
        return [
            [['frames_info_id'], 'default', 'value' => null],
            [['frames_info_position'], 'default', 'value' => 0],
            [['self_harm_animated'], 'default', 'value' => 0.000],
            [['moderation_id', 'type_real'], 'required'],
            [['media_id'], 'safe'],
            [['frames_info_position'], 'integer'],
            ...
            [['moderation_id', 'frames_info_id'], 'string', 'max' => 255],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'media_id' =>   'Media Id',
            'frames_info_id' => 'Frames Info ID',
            'frames_info_position' => 'Frames Info Position',
