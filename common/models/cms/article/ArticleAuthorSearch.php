...
/**
 */
class ArticleAuthorSearch extends ArticleAuthor
{
    ...
    {
        return [
            [['article_id', 'created_at', 'created_by', 'updated_by', 'updated_at', 'status'], 'safe'],
    ...
    {
        $query =  ArticleAuthor::find()->andWhere(['status' => [self::STATUS_ACTIVE, self::STATUS_SUSPEND]]);
