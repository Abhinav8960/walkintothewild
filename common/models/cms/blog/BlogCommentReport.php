...
/**
 * This is the model class for table "blog_comment_report".
 *
 * @property int $id
 * @property int|null $blog_id
 * @property int|null $user_id
 * @property int|null $blog_comment_id
 ...
 */
class BlogCommentReport extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['blog_id', 'user_id', 'blog_comment_id', 'report_reason_id', 'created_at', 'created_by', 'updated_at', 'updated_by', 'status'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'blog_id' => 'Blog ID',
            'user_id' => 'User ID',
            'blog_comment_id' => 'Blog Comment ID',
    ...
    {
        return isset($this->blog) ? $this->blog->title : '';
    }
