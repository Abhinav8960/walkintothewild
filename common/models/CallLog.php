...
class CallLog extends \common\models\trierror\ActiveLogRecord implements \common\interfaces\NewStatusInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['service', 'chat_id', 'lead_id', 'ivr_duration', 'service_user_id', 'talk_duration', 'agent_on_call_duration', 'last_first_duration', 'cust_answer_duration', 'hangup_by_source_detected', 'forward', 'total_hold_duration', 'request_caller_1_user_id', 'request_caller_2_user_id', 'operator_user_id', 'call_initiated_user_id', 'call_initiated_partner_id', 'status', 'is_detail_fetched', 'created_at', 'updated_at'], 'integer'],
            [['reference_id', 'chat_id', 'ivr_duration', 'service_user_id', 'master_agent_number', 'master_group_id', 'last_first_duration', 'cust_answer_duration', 'hangup_by_source_detected', 'total_hold_duration'], 'required'],
            [['ivr_s_time', 'ivr_e_time', 'first_answer_time', 'last_hangup_time', 'cust_answer_s_time', 'cust_answer_e_time'], 'safe'],
            ...
            [['did', 'c_type', 'camp_id', 'exc_adm', 'c_number', 'master_num_ctc', 'master_agent', 'master_agent_number', 'master_group_id', 'call_id', 'first_attended', 'ivr_execute_flow', 'recording_url', 'dial_status', 'call_type', 'call_status', 'file_path', 'call_request_status', 'call_request_message'], 'string', 'max' => 255],
