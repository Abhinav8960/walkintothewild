...
class CallLog extends \common\models\trierror\ActiveLogRecord implements \common\interfaces\NewStatusInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['reference_id', 'ivr_duration', 'service_user_id',  'master_group_id', 'last_first_duration', 'cust_answer_duration', 'hangup_by_source_detected', 'total_hold_duration'], 'required'],
            [['ivr_s_time', 'ivr_e_time', 'first_answer_time', 'last_hangup_time', 'cust_answer_s_time', 'cust_answer_e_time', 'forward', 'master_agent_number', 'camp_id', 'exc_adm', 'call_status', 'master_group_id', 'chat_id', 'lead_id'], 'safe'],
