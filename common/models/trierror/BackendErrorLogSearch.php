...
/**
 * BackendErrorLogSearch represents the model behind the search form of `common\models\BackendErrorLog`.
 */
class BackendErrorLogSearch extends BackendErrorLog
{
