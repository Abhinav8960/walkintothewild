 ...
 */
class MasterPackageTagSearch extends MasterPackageTag
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = MasterPackageTag::find()->where(['status' => [MasterPackageTag::STATUS_ACTIVE, MasterPackageTag::STATUS_SUSPEND]]);
