...
/**
 * ShareSafariRequestSearch represents the model behind the search form of `common\models\sharesafari\ShareSafariRequest`.
 */
class ShareSafariRequestSearch extends ShareSafariRequest
{
    public $month_id;
    ...
    public function search($params, $pagination = true)
    {
        ...
        $query->andFilterWhere([
            'id' => $this->id,
            'share_safari_request.host_user_id' => $this->host_user_id,
            'share_safari_request.host_type' => $this->host_type,
            'share_safari_request.park_id' => $this->park_id,
            'share_safari_request.share_safari_agenda_id' => $this->share_safari_agenda_id,
            'share_safari_request.start_date' => $this->start_date,
            'share_safari_request.end_date' => $this->end_date,
            'share_safari_request.stay_category_id' => $this->stay_category_id,
            'share_safari_request.is_approved' => $this->is_approved,
            'share_safari_request.total_seat' => $this->total_seat,
            'share_safari_request.share_seat' => $this->share_seat,
