...
class ShareSafariVersionSearch extends ShareSafariVersion
{
    ...
    {
        return [
            [['host_user_id','safari_operator_id','user_id', 'host_type', 'park_id', 'share_safari_agenda_id', 'no_of_safari', 'stay_category_id', 'estimate_price_min', 'estimate_price_max', 'total_seat', 'share_seat', 'created_at', 'created_by', 'updated_at', 'updated_by', 'status'], 'safe'],
    ...
    public function fixeddeparturesearch($params, $pagination = true)
    {
        ...
        $query->andFilterWhere([
            ...
            'share_safari.start_date' => $this->start_date,
            'share_safari.end_date' => $this->end_date,
            'share_safari.cut_off_date' => $this->cut_off_date,
            'share_safari.stay_category_id' => $this->stay_category_id,
            'share_safari.total_seat' => $this->total_seat,
            'share_safari.share_seat' => $this->share_seat,
            'share_safari.created_at' => $this->created_at,
    ...
    public function partnersearch($params, $pagination = true)
    {
        $query = ShareSafariVersion::find();
        ...
        $query->andFilterWhere([
            ...
            'share_safari_version.safari_operator_id' => $this->safari_operator_id,
            ...
            'share_safari_version.start_date' => $this->start_date,
            'share_safari_version.end_date' => $this->end_date,
            'share_safari_version.stay_category_id' => $this->stay_category_id,
            'share_safari_version.total_seat' => $this->total_seat,
            'share_safari_version.share_seat' => $this->share_seat,
            'share_safari_version.created_at' => $this->created_at,
            'share_safari_version.created_by' => $this->created_by,
            'share_safari_version.updated_at' => $this->updated_at,
            'share_safari_version.updated_by' => $this->updated_by,
            'share_safari_version.is_published_on_api' => $this->is_published_on_api,
            'share_safari_version.is_published_on_web' => $this->is_published_on_web,
            'share_safari_version.status' => $this->status,
        ]);
        $query->andFilterWhere(['like', 'safari_plan', $this->safari_plan]);
