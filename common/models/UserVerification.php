 ...
 * @property Post[] $posts
 */
class UserVerification extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['name'], 'safe'],
            [['user_bio', 'user_flaged', 'mobile_no', 'is_mobile_no_verified', 'mobile_no_verified_at'], 'safe']
        ];
    }
    ...
    {
        return static::find()
            ->where(['username' => $username, 'status' => self::STATUS_ACTIVE])->one();
    }
