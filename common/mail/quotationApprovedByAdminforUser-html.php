            ...
            <?php if (isset($qr_code) && $qr_code): ?>
                <tr>
                    ...
                    <td style="padding: 10px; border: 1px solid #ddd;">
                        <img src="<?= urldecode($qr_code) ?>" alt="QR Code" style="max-width: 250px; max-height: 250px;">
        ...
        <tbody>
            <tr>
                <td bgcolor="#ffffff" style="background: #ffffff;border: 1px solid #999999;padding: 0.04cm 0cm;">
                    <p style="line-height: 115%;text-align: justify;margin-bottom: 0.25cm;background: transparent;"><span style="color: rgb(30, 137, 134);"><strong>T&amp;C of Walkintothewild Technologies Private Limited (&ldquo;MEDIARC or WALKINTOTHEWILD&rdquo;)</strong></span></p>
                </td>
            </tr>
            <tr>
                <td bgcolor="#ffffff" style="background: #ffffff;border: 1px solid #999999;padding: 0.04cm 0cm;">
                    <p style="line-height: 115%;text-align: justify;margin-bottom: 0.25cm;background: transparent;">Cancellation Service Charge: INR 5,000/- per person (Non-refundable Standard Cancellation)</p>
                </td>
            </tr>
            <tr>
                <td bgcolor="#ffffff" style="background: #ffffff;border: 1px solid #999999;padding: 0.04cm 0cm;">
                    <ul>
                        ...
                        <li>
                            <p style="line-height: 115%;text-align: justify;background: transparent;margin-bottom: 0cm;">If the booking is cancelled due to delayed or non-payment as per the agreed terms, an additional fee of INR 2,000 may be applicable (if applicable).</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p style="line-height: 115%;text-align: justify;background: transparent;margin-bottom: 0cm;">In case of non-compliance of payment terms, WALKINTOTHEWILD reserves the right to cancel the booking and in such case, no refund shall be allowed.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p style="line-height: 115%;text-align: justify;background: transparent;margin-bottom: 0cm;">.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p style="line-height: 115%;text-align: justify;background: transparent;margin-bottom: 0cm;">The customer shall receive a refund after the deduction of all applicable charges, in accordance with the refund policies of both WALKINTOTHEWILD and the respective operator.</p>
                        </li>
                        <li>
                            <p style="line-height: 115%;text-align: justify;background: transparent;margin-bottom: 0cm;">Cancellation amount/charges will be calculated as per total booking amount, irrespective of whether full booking amount has been paid or not.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p style="line-height: 115%;text-align: justify;background: transparent;margin-bottom: 0cm;">Cost of expenses of personal nature at the place of stay, such as laundry, telephone calls, room service, alcoholic beverages, mini bar etc. not mentioned in the inclusions will have to be borne by the customer.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p style="line-height: 115%;text-align: justify;background: transparent;margin-bottom: 0cm;">Customers can&rsquo;t change the itinerary during the trip unless the same has been pre-informed and assented by the operator or the WALKINTOTHEWILD.</p>
                        </li>
                        <li>
                            <p style="line-height: 115%;text-align: justify;background: transparent;margin-bottom: 0cm;">WALKINTOTHEWILD can&rsquo;t guarantee hotel services or food quality. If you face any issues, please let your operator know right away so that they can help fix the problem quickly.</p>
                        </li>
                        <li>
                            <p style="line-height: 115%;text-align: justify;background: transparent;margin-bottom: 0cm;">WALKINTOTHEWILD/operator do not take guarantee for any services revoked from the hotel without prior notice.</p>
                        </li>
                        <li>
                            <p style="line-height: 115%;text-align: justify;background: transparent;margin-bottom: 0cm;">WALKINTOTHEWILD shall not be liable for any losses incurred by the customers due to violation of rules of local authority or the government.</p>
                        </li>
                        <li>
                            <p style="line-height: 115%;text-align: justify;background: transparent;margin-bottom: 0cm;">In case on any currency fluctuations or amendment in local Government taxes, WALKINTOTHEWILD reserves the right to adjust the tour price accordingly.</p>
                        </li>
                        <li>
                            <p style="line-height: 115%;text-align: justify;background: transparent;margin-bottom: 0cm;">For meals included in the package as part of sightseeing/activity, the menu is preset and specific choice of meal may not be available.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p style="line-height: 115%;text-align: justify;background: transparent;margin-bottom: 0.49cm;"><u><strong>Responsibilities of the Operators:</strong></u></p>
                        </li>
                    </ul>
                    ...
                    <p style="line-height: 115%;text-align: justify;margin-bottom: 0.25cm;background: transparent;margin-left: 1.27cm;"><br></p>
                </td>
            </tr>
            <tr>
                <td bgcolor="#ffffff" style="background: #ffffff;border: 1px solid #999999;padding: 0.04cm 0cm;">
                    <ul>
                        <li>
                            <p style="line-height: 115%;text-align: justify;background: transparent;margin-bottom: 0cm;">Standard check-in timings of hotels are 12 pm and check-out is 11 am. Early check-in and late check-out will be available as per hotel availability and hotel rules.</p>
                        </li>
                        <li>
                            <p style="line-height: 115%;text-align: justify;background: transparent;margin-bottom: 0cm;">Car/driver details will be provided by the operator prior to travel start date.</p>
                        </li>
                        <li>
                            <p style="line-height: 115%;text-align: justify;background: transparent;margin-bottom: 0cm;">It is mandatory to carry a valid photo identity card for hotel stay (Passport/Driving License/Voter ID card/Aadhar card)</p>
                        </li>
                        <li>
                    ...
                    <p style="line-height: 115%;text-align: justify;margin-bottom: 0.25cm;background: transparent;margin-left: 1.27cm;margin-top: 0.49cm;"><br></p>
                </td>
            </tr>
            <tr>
                <td bgcolor="#ffffff" style="background: #ffffff;border: 1px solid #999999;padding: 0.04cm 0cm;">
                    <ul>
                        ...
                        <li>
                            <p style="line-height: 115%;text-align: justify;background: transparent;margin-bottom: 0cm;">Inner Line permit are subject to government policies and office timings. WALKINTOTHEWILD shall not be liable for any changes made due to this.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p style="line-height: 115%;text-align: justify;background: transparent;margin-bottom: 0cm;">Air Conditioning in car will not be available in hilly areas unless mentioned in Inclusions.</p>
                        </li>
                        <li>
                            <p style="line-height: 115%;text-align: justify;margin-bottom: 0.25cm;background: transparent;">In case a hotel is non-operational, WALKINTOTHEWILD/operator reserves the right to change the hotel to next best option available.&nbsp;</p>
                        </li>
                    </ul>
                </td>
            </tr>
