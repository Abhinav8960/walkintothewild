                                        ...
                                        <p style="font-size: 16px; font-family: Arial, sans-serif; color: #555555; margin: 0 0 20px;">
                                            <?= $creator_name && isset($creator_name) ? $creator_name : '' ?> has created new <?php if ($shared_safari && $shared_safari['type'] == 1) {
                                                                                                                                    ...
                                                                                                                                    echo "fixed departure";
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        echo "fixed departure ";
                                                                                                                                                                                                                                                                    } ?>and connect for your trip planning.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            <a href="<?= $shared_safari_url && isset($shared_safari_url) ? $shared_safari_url : '' ?>" style="display: inline-block; background-color: #09422d; color: #ffffff; text-decoration: none; padding: 10px 20px; border-radius: 20px; font-size: 16px; font-family: Arial, sans-serif; margin-top: 10px;">View</a>
