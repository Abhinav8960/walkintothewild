...
<center>
    ...
    <div style="border-radius: 15px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);  padding: 20px; text-align: center; width: 400px; background-color: white; margin:20px; margin-top:30px;">
        <h2 style="text-align: center; font-size:25px;  font-family: Arial, sans-serif;">New Member Alert</h2>
        <div style="border-radius: 15px; margin-top:20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); transition: 0.3s; text-align: center; padding: 10px; background-color:#ecedf1;">
            <p style="font-family: Arial, sans-serif;"> <?= $username && isset($username) ? $username : '' ?> has unjoined your shared safari <?= $shared_safari && isset($shared_safari['share_safari_title']) ? $shared_safari['share_safari_title'] : '' ?>. Visit the interested member section to review and connect for your trip planning. </p>
        </div>
