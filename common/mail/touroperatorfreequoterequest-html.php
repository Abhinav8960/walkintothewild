...
<div class="verify-email">
    ...
    <p> You have received a new quote request for <?= isset($package_name) ? 'Package' : '' ?> <?= Html::encode($parkname) ?>. Please check your inbox to review the details and respond promptly. </p>
