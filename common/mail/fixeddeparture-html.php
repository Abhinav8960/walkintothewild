...
<div class="contact-form" style="font-family: Arial, sans-serif; font-size: 14px; color: #333; padding: 20px; border: 1px solid #ddd; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
    ...
    <p style="margin-bottom: 20px;"><?= $operator_name && isset($operator_name) ? $operator_name : '' ?> created a new Fixed Departure.</p>
    <br>
    <table style="width: 100%; border-collapse: collapse;">
        <tbody>
            ...
            <tr>
                ...
                <td style="padding: 10px; border: 1px solid #ddd;"><?= $shared_safari_url && isset($shared_safari_url) ? $shared_safari_url : '' ?></td>
            </tr>
        </tbody>
    </table>
    <br>
