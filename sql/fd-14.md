...
ALTER TABLE `share_safari` ADD `self_occupied_seat` INT NULL DEFAULT NULL AFTER `total_seat`;


###      Run version table Here


ALTER TABLE `share_safari_version` ADD `gallery_version` INT NULL DEFAULT NULL AFTER `gallery_json`;
ALTER TABLE `share_safari_version` ADD `self_occupied_seat` INT NULL DEFAULT NULL AFTER `total_seat`;
