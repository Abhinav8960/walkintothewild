...
CREATE TABLE `site_pages` (
  ...
  `content_table` varchar(155) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `url` varchar(555) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `url_type` varchar(155) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `title` varchar(1055) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `keywords` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `image` varchar(1055) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `get_parameter` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `post_parameter` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `last_update_at` datetime DEFAULT NULL,
  `counter` int NOT NULL DEFAULT '0',
  `is_get` tinyint NOT NULL DEFAULT '0',
  `is_post` tinyint NOT NULL DEFAULT '0',
