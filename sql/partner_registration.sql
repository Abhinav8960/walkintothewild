...
--
-- Host: localhost:3306
-- Generation Time: Apr 25, 2025 at 08:38 PM
...
CREATE TABLE `partner_registration` (
  ...
  `legal_entity_whatsapp` int DEFAULT NULL,
  ...
  `billing_phone` int DEFAULT NULL,
  ...
  `kyc_phone` int DEFAULT NULL,
  `kyc_whatsapp` int DEFAULT NULL,
  ...
  `form1_status` int NOT NULL DEFAULT '0' COMMENT '0 => empty,\r\n1=filled,\r\n2=>approved,\r\n3=>return',
  `form2_status` int NOT NULL DEFAULT '0' COMMENT '0 => empty,\r\n1=filled,\r\n2=>approved,\r\n3=>return',
  `form3_status` int NOT NULL DEFAULT '0' COMMENT '0 => empty,\r\n1=filled,\r\n2=>approved,\r\n3=>return',
  `form4_status` int NOT NULL DEFAULT '0' COMMENT '0 => empty,\r\n1=filled,\r\n2=>approved,\r\n3=>return',
  `form5_status` int NOT NULL DEFAULT '0' COMMENT '	0 => empty, 1=filled, 2=>approved, 3=>return	',
