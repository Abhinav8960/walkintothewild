...
DROP TABLE IF EXISTS `compliance_documents_version`;
CREATE TABLE `compliance_documents_version` (
  `id` int NOT NULL,
  `version` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `type` int DEFAULT NULL COMMENT '1 => Terms and Conditions ,\r\n2 => Privacy Policy ,\r\n3 => Refund Policy',
  `content` text,
