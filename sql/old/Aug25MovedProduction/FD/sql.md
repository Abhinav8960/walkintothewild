...
ALTER TABLE transaction ADD payment_gateway_tracking_id VARCHAR(100) NULL DEFAULT NULL AFTER id, ADD bank_reference_no VARCHAR(100) NULL DEFAULT NULL AFTER payment_gateway_tracking_id;
...
ALTER TABLE firebase_notification_log CHANGE message message MEDIUMTEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL;