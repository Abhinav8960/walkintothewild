...
CREATE TABLE `transaction` (
  ...
  `lead_partner_quotes_id` int NOT NULL,
  `lead_partner_quote_installments_id` int NOT NULL,
  ...
  `installment` int NOT NULL DEFAULT '1' COMMENT 'Installment_id',
  ...
  `status` int DEFAULT '1' COMMENT '0=>initiated,1=>Success,2=>Failed,3=>Hold,4=>Refunded'
